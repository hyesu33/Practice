...
irregular_verbs = {
    ...
    "buy": "bought", "find": "found", "send": "sent", "make": "made"
}
...
st.markdown(f"### ✏️ Active Sentence:\n**{current}**")
...
if st.button("➡️ Next Sentence"):
    ...
    if st.session_state.index >= len(examples):
        st.session_state.index = 0  # Loop back to start
